...
Match.find(38).update_attributes(turn: 1, court: 4, status: "Start-at", start_time: Time.zone.local(2019,3,24,13,30,0))
Match.find(41).update_attributes(turn: 1, court: 5, status: "Start-at", start_time: Time.zone.local(2019,3,24,13,30,0))
Match.find(42).update_attributes(turn: 1, court: 6, status: "Start-at", start_time: Time.zone.local(2019,3,24,13,30,0))
Match.find(65).update_attributes(turn: 1, court: 10, status: "Not-before", start_time: Time.zone.local(2019,3,24,13,0,0))
Match.find(70).update_attributes(turn: 1, court: 11, status: "Not-before", start_time: Time.zone.local(2019,3,24,13,0,0))
...
Match.find(81).update_attributes(turn: 2, court: 3, status: "Followed-by")
